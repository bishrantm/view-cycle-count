import svgPaths from "./svg-6dxuqt14a3";
    ...
    <div className="bg-white content-stretch flex flex-col gap-[4px] isolate items-start relative rounded-[12px] size-full" data-name="Item Selection">
      ...
      <div className="relative shrink-0 w-full z-[1]">
        <div className="content-stretch flex gap-[16px] items-start p-[16px] relative w-full">
                    ...
                    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-[220px]">
                      ...
                      <div className="content-stretch flex h-[21px] items-center relative shrink-0" data-name="Unit Status">
                        <div className="bg-white h-full relative rounded-[6px] shrink-0" data-name="Label">
                          <div className="content-stretch flex gap-[4px] h-full items-center overflow-clip pr-[6px] relative rounded-[inherit]">
                            <div className="bg-[#f7f7f8] content-stretch flex h-full items-center justify-center px-[8px] py-[4px] relative shrink-0">
                              <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[normal] overflow-hidden relative shrink-0 text-[#252525] text-[14px] text-ellipsis text-left">Lot</p>
                            </div>
                            <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#68727d] text-[14px] text-left">Serialized</p>
                          </div>
                          <div aria-hidden="true" className="absolute border border-[#eaebf0] border-solid inset-0 pointer-events-none rounded-[6px]" />
                        </div>
                      </div>
                  ...
                  <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Style=Outlined">
                    <div className="absolute inset-[20.83%]" data-name="Vector">
                      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.33333 9.33333">
                        <path d={svgPaths.p951d880} fill="var(--fill-0, #0A77FF)" id="Vector" />
                      </svg>
                    </div>
                  </div>
          ...
          <div className="bg-[#ecf4fc] flex-[1_0_0] h-[800px] min-h-px min-w-px relative rounded-[12px]">
            ...
            <div className="flex flex-col items-center size-full">
              <div className="content-stretch flex flex-col gap-[16px] items-center pb-[24px] pt-[14px] px-[12px] relative size-full">
                ...
                <div className="bg-white content-stretch flex flex-col gap-[16px] items-start justify-center pb-[16px] pt-[6px] relative rounded-[8px] shadow-[0px_1px_3px_0px_rgba(16,24,40,0.1),0px_1px_2px_0px_rgba(16,24,40,0.1)] shrink-0 w-[540px]" data-name="Non-Serialized Lot">
                          ...
                          <div className="overflow-clip relative shrink-0 size-[16px]" data-name="multi-location">
                            <div className="absolute inset-[12.5%_4.17%_4.17%_12.5%]" data-name="Vector">
                              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.3333 13.3333">
                                <path d={svgPaths.p35e5bdd0} fill="var(--fill-0, #0A77FF)" id="Vector" />
                              </svg>
                            </div>
                          </div>
                          ...
                          <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Style=Outlined">
                            <div className="absolute inset-[8.33%_16.67%]" data-name="Vector">
                              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.6667 13.3333">
                                <path d={svgPaths.p2d3a6b00} fill="var(--fill-0, #68727D)" id="Vector" />
                              </svg>
                            </div>
                          </div>
