import svgPaths from "./svg-xj1tx8k3s";
...
export default function TagDropdownV() {
  return (
    <div className="bg-white relative rounded-[12px] size-full" data-name="Tag Dropdown v2">
      <div className="content-stretch flex flex-col gap-[6px] items-center justify-center overflow-clip pb-[14px] pt-[12px] px-[12px] relative rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
            ...
            <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
              <div className="content-stretch flex items-center justify-between pl-[12px] pr-[6px] py-[6px] relative w-full">
                <div className="content-stretch flex gap-[2px] items-center relative shrink-0">
                  <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#252525] text-[14px] text-left whitespace-nowrap">100219-44</p>
          ...
          <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
            <div className="overflow-clip relative shrink-0 size-[14px]" data-name="warning">
              <div className="absolute inset-[10.42%_4.17%]" data-name="Vector">
                <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.8333 11.0833">
                  <path d={svgPaths.p2a601080} fill="var(--fill-0, #E33B32)" id="Vector" />
                </svg>
              </div>
            </div>
            <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#e33b32] text-[12px] whitespace-nowrap">100219-44 serial unit is already in the system</p>
          </div>
        </div>
      </div>
