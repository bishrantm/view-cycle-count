import svgPaths from "./svg-rx2nbgyv9n";
...
function Group() {
  return (
    <div className="absolute inset-[4.17%]" data-name="Group">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 29.3333 29.3322">
        <g id="Group">
          <path d={svgPaths.p22d266f2} fill="var(--fill-0, #574EFA)" id="Vector" />
          <path d={svgPaths.paee3700} fill="var(--fill-0, #574EFA)" id="Vector_2" />
          <path d={svgPaths.p31ed6100} fill="var(--fill-0, #574EFA)" id="Vector_3" />
          <path d={svgPaths.p27abb600} fill="var(--fill-0, #574EFA)" id="Vector_4" />
          <path d={svgPaths.p19918400} fill="var(--fill-0, #574EFA)" id="Vector_5" />
        </g>
      </svg>
    </div>
  );
...
function Layer() {
  return (
    <div className="absolute contents inset-[4.17%]" data-name="Layer 1">
      <Group />
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
      <div className="bg-[#edecff] content-stretch flex items-center justify-center p-[8px] relative rounded-[5px] shrink-0" data-name=".Icon placeholder">
        <div className="overflow-clip relative shrink-0 size-[32px]" data-name="Icon">
          <Layer />
        </div>
      </div>
      <p className="font-['Figtree:SemiBold',sans-serif] font-semibold leading-[normal] min-w-full relative shrink-0 text-[#272d37] text-[24px] tracking-[-0.24px] w-[min-content]">Select Item Recount Method</p>
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="keyboard_double_arrow_down">
        <div className="absolute bottom-[20.83%] left-1/4 right-1/4 top-[20.83%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 9.33333">
            <g id="Vector">
              <path d={svgPaths.p1ba4e280} fill="var(--fill-0, #DB3A33)" />
              <path d={svgPaths.p1d79080} fill="var(--fill-0, #DB3A33)" />
            </g>
          </svg>
        </div>
      </div>
      <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#252525] text-[16px] whitespace-nowrap">900 EA</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0">
      ...
      <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#db3a33] text-[16px] text-right whitespace-nowrap">-100 EA</p>
    </div>
  );
}
...
function Header() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="header">
      ...
      <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#252525] text-[14px] whitespace-nowrap">Recount in this plan</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-white relative rounded-[8px] shrink-0 w-full" data-name="Checkbox & Text">
      ...
      <div className="content-stretch flex flex-col gap-[6px] items-start p-[12px] relative w-full">
        <Header />
        <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[normal] min-w-full relative shrink-0 text-[#68727d] text-[14px] w-[min-content]">Send this item back to Pending in the current plan so it can be counted again.</p>
      </div>
    </div>
  );
}
...
function Header1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="header">
      ...
      <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#252525] text-[14px] whitespace-nowrap">New Plan</p>
    </div>
  );
}
...
function CheckboxText1() {
  return (
    <div className="bg-white relative rounded-[8px] shrink-0 w-full" data-name="Checkbox & Text">
      ...
      <div className="content-stretch flex flex-col gap-[6px] items-start p-[12px] relative w-full">
        <Header1 />
        <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[normal] min-w-full relative shrink-0 text-[#68727d] text-[14px] w-[min-content]">Change the line item’s status to Cancelled in the current plan, then create a new cycle count plan for it.</p>
      </div>
    </div>
  );
}
...
export default function RecountSpecific() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[28px] items-start p-[24px] relative rounded-[8px] size-full" data-name="Recount Specific">
        ...
        <div className="bg-[#0a77ff] flex-[1_0_0] min-h-px min-w-px relative rounded-[6px] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.04)]" data-name="Button">
          <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
            <div className="content-stretch flex gap-[6px] items-center justify-center px-[18px] py-[12px] relative w-full">
              ...
              <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[22px] not-italic relative shrink-0 text-[15px] text-white whitespace-nowrap">Confirm Recount</p>
            </div>
          </div>
        </div>
      </div>
