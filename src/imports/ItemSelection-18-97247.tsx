import svgPaths from "./svg-gt693an7l5";
        ...
        <div className="content-stretch flex gap-[16px] items-start p-[16px] relative size-full">
          <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-[364px]">
            <div className="content-stretch flex flex-col gap-[14px] items-start relative shrink-0">
              <button className="bg-[#fafbfc] content-stretch cursor-pointer flex h-[110px] items-center p-[12px] relative rounded-[8px] shrink-0 w-[364px]" data-name="Count Type Thumbnails">
                  ...
                  <div className="content-stretch flex flex-col gap-[12px] items-start pl-[12px] relative shrink-0" data-name="Container">
                    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-[220px]">
                      ...
                      <div className="bg-[#eaebf0] content-stretch flex gap-[2px] items-center px-[6px] py-[2px] relative rounded-[4px] shrink-0" data-name="Item Type Tags">
                        ...
                        <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#252525] text-[12px] text-left">Non-Serialized</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="content-stretch flex flex-col gap-[12px] items-start pl-[12px] relative shrink-0" data-name="Container">
                    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-[220px]">
                      ...
                      <div className="bg-[#eaebf0] content-stretch flex gap-[2px] items-center px-[6px] py-[2px] relative rounded-[4px] shrink-0" data-name="Item Type Tags">
                        ...
                        <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#252525] text-[12px]">Serialized</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col justify-center size-full">
                    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center pb-[16px] pt-[12px] px-[14px] relative w-full">
                      <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
                        ...
                        <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#68727d] text-[15px] w-[240px] whitespace-pre-wrap">Select all 2 Locations</p>
                      </div>
                      <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
                        <div className="content-stretch flex gap-[14px] items-start relative shrink-0 w-[194px]">
                          ...
                          <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px relative">
                            ...
                            <p className="font-['Figtree:Regular',sans-serif] font-normal leading-[normal] min-w-full overflow-hidden relative shrink-0 text-[#68727d] text-[13px] text-ellipsis w-[min-content] whitespace-pre-wrap">Loading Dock 1, Central Distribution Center</p>
                          </div>
                        </div>
                        <div className="bg-[#f7f7f8] content-stretch flex items-center px-[8px] py-[2px] relative rounded-[128px] shrink-0" data-name="Label">
                          <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#68727d] text-[13px]">200 EA</p>
                        </div>
                      ...
                      <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
                        <div className="content-stretch flex gap-[14px] items-start relative shrink-0 w-[194px]">
                          ...
                          <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px relative">
                            ...
                            <p className="font-['Figtree:Regular',sans-serif] font-normal leading-[normal] min-w-full overflow-hidden relative shrink-0 text-[#68727d] text-[13px] text-ellipsis w-[min-content] whitespace-pre-wrap">Loading Dock 2, Central Distribution Center</p>
                          </div>
                        </div>
                        <div className="bg-[#f7f7f8] content-stretch flex items-center px-[8px] py-[2px] relative rounded-[128px] shrink-0" data-name="Label">
                          <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#68727d] text-[13px]">2 EA out of 200 EA</p>
                        </div>
                        <div className="bg-[#ecf4fc] content-stretch flex gap-[6px] items-center justify-center overflow-clip px-[12px] py-[8px] relative rounded-[6px] shrink-0" data-name="Button">
                          <p className="font-['Figtree:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#0a77ff] text-[14px] tracking-[0.1px]">View Units</p>
                        </div>
