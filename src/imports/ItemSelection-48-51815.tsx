import svgPaths from "./svg-3kbnp738ee";
...
import imgItemSelection3 from "figma:asset/9edf3ae748122d6ad61287f140b75382b5902a6a.png";
import imgItemSelection4 from "figma:asset/69115701eb59753545c34c08b5df63d986702686.png";
import imgItemSelection5 from "figma:asset/2bbe2f6875f0243664a668c035b6de655f106dd4.png";
          ...
          <div className="content-stretch flex gap-[12px] isolate items-center pb-[24px] pt-[16px] px-[16px] relative w-full">
            <div className="flex flex-[1_0_0] flex-row items-center self-stretch">
              <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] h-full items-start justify-center min-h-px min-w-px relative z-[3]" data-name="Heading">
                <p className="font-['Figtree:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#252525] text-[18px] tracking-[-0.18px] w-full whitespace-pre-wrap">Choose items to count</p>
                ...
                <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
                  <div className="content-stretch flex items-center justify-between px-[12px] py-[10px] relative size-full">
                    <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
                      ...
                      <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#a1a4ac] text-[14px]">{`Enter item, serial number location  or category`}</p>
                    </div>
        ...
        <div className="content-stretch flex gap-[16px] items-start p-[16px] relative size-full">
          <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-[364px]">
            <div className="content-stretch flex flex-col gap-[14px] items-start relative shrink-0">
                ...
                <div className="content-stretch flex items-center relative shrink-0" data-name="Data">
                  <div className="h-[82px] relative rounded-[6px] shrink-0 w-[80px]">
                    <div className="overflow-clip relative rounded-[inherit] size-full">
                      <div className="absolute inset-[-3.66%_-5%]" data-name="image">
                        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgItemSelection3} />
                      </div>
                    </div>
                  ...
                  <div className="content-stretch flex flex-col gap-[12px] items-start pl-[12px] relative shrink-0" data-name="Container">
                    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-[220px]">
                      ...
                      <div className="content-stretch flex h-[21px] items-center relative shrink-0" data-name="Unit Status">
              ...
              <div className="bg-[#f3f9ff] h-[110px] relative rounded-[8px] shadow-[0px_0px_1px_0px_rgba(113,128,150,0.04),0px_4px_8px_0px_rgba(113,128,150,0.08)] shrink-0 w-[364px]" data-name="Component 48">
                      ...
                      <div className="absolute inset-[-3.66%_-5%]" data-name="image">
                        <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
                          ...
                          <div className="absolute inset-0 overflow-hidden">
                            <img alt="" className="absolute left-1/4 max-w-none size-1/2 top-1/4" src={imgItemSelection4} />
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="-translate-y-1/2 absolute flex items-center justify-center left-[347.95px] size-[27.373px] top-[calc(50%+0.68px)]" style={{ "--transform-inner-width": "1185", "--transform-inner-height": "0" } as React.CSSProperties}>
            ...
            <div className="bg-white relative rounded-[6px] shrink-0 w-full" data-name="Button">
              <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
                <div className="content-stretch flex gap-[6px] items-center justify-center pl-[8px] pr-[12px] py-[8px] relative w-full">
                  ...
                  <p className="font-['Figtree:SemiBold',sans-serif] font-semibold leading-[20px] relative shrink-0 text-[#0a77ff] text-[14px] tracking-[0.1px]">Add Items</p>
                </div>
              </div>
              <div aria-hidden="true" className="absolute border border-[#eaebf0] border-solid inset-[-0.5px] pointer-events-none rounded-[6.5px] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)]" />
            </div>
              ...
              <div className="content-stretch flex flex-col gap-[16px] items-center pb-[24px] pt-[14px] px-[12px] relative size-full">
                <div className="bg-white content-stretch flex flex-col gap-[14px] items-center justify-center py-[8px] relative rounded-[8px] shadow-[0px_0px_1px_0px_rgba(113,128,150,0.04),0px_4px_8px_0px_rgba(113,128,150,0.08)] shrink-0 w-full">
                  <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-[512px]" data-name="Item Details">
                    <div className="relative rounded-[6px] shrink-0 size-[86px]" data-name="Item Image">
                      <div className="overflow-clip relative rounded-[inherit] size-full">
                        <div className="absolute inset-[-3.66%_-5%]" data-name="image">
                          <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
                            <img alt="" className="absolute max-w-none object-cover size-full" src={imgItemSelection5} />
                    ...
                    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative" data-name="Header">
                      <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
                        <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full" data-name="Part No + Quantity">
                          <p className="flex-[1_0_0] font-['Figtree:SemiBold',sans-serif] font-semibold leading-[normal] min-h-px min-w-px relative text-[#252525] text-[18px] whitespace-pre-wrap">P 200-12</p>
                      ...
                      <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Extra Info">
                        ...
                        <div className="bg-[#efeff1] content-stretch flex gap-[2px] h-[21px] items-center px-[6px] py-[3px] relative rounded-[6px] shrink-0" data-name="Item Type Tags">
                          ...
                          <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#252525] text-[14px]">4 Categories</p>
                        </div>
                        <div className="bg-[#efeff1] content-stretch flex gap-[2px] h-[21px] items-center px-[6px] py-[3px] relative rounded-[6px] shrink-0" data-name="Item Type Tags">
                          <div aria-hidden="true" className="absolute border border-[#eaebf0] border-solid inset-0 pointer-events-none rounded-[6px]" />
                          <div className="overflow-clip relative shrink-0 size-[12px]" data-name="Lead Icon">
                          ...
                          <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#252525] text-[14px]">2 Locations</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0">
                    ...
                    <div className="content-stretch flex h-[36px] items-center relative shrink-0 w-[512px]">
                      <div className="content-stretch flex gap-[8px] items-center relative shrink-0">
                ...
                <div className="bg-white content-stretch flex flex-col gap-[16px] items-start justify-center pb-[16px] pt-[6px] relative rounded-[8px] shadow-[0px_1px_3px_0px_rgba(16,24,40,0.1),0px_1px_2px_0px_rgba(16,24,40,0.1)] shrink-0 w-[540px]" data-name="Serialized Lots">
                          ...
                          <div className="overflow-clip relative shrink-0 size-[16px]" data-name="multi-location">
                            <div className="absolute inset-[12.5%_4.17%_4.17%_12.5%]" data-name="Vector">
                              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
                                <path d={svgPaths.p102b6400} fill="var(--fill-0, #0A77FF)" id="Vector" />
                              </svg>
                            </div>
                          </div>
                          <p className="font-['Figtree:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#0a77ff] text-[14px]">Lot</p>
                        </div>
                          ...
                          <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Style=Outlined">
                            <div className="absolute inset-[8.33%_16.67%]" data-name="Vector">
                              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 20">
                                <path d={svgPaths.p2fcac600} fill="var(--fill-0, #68727D)" id="Vector" />
                              </svg>
                            </div>
                          </div>
                          <p className="font-['Figtree:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#68727d] text-[14px] text-left">Location</p>
                        </div>
                        <div aria-hidden="true" className="absolute border-[#eaebf0] border-b border-solid inset-0 pointer-events-none" />
                      </button>
                      <button className="cursor-pointer h-[34px] relative shrink-0" data-name=".Tab base">
                            ...
                            <div className="content-stretch flex items-start relative shrink-0" data-name="Toggle">
                              <div className="content-stretch flex gap-[14px] items-center relative self-stretch shrink-0 w-[304px]" data-name="Toggle">
                                ...
                                <div className="content-stretch flex flex-[1_0_0] flex-col gap-[2px] items-start min-h-px min-w-px relative" data-name="Text container">
                                  <p className="font-['Figtree:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[#252525] text-[15px]">Count all Lots</p>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="content-stretch flex flex-col gap-[20px] items-start relative shrink-0 w-full">
                        <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
                          <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
                            <div className="content-stretch flex gap-[14px] items-center relative shrink-0 w-[200px]">
                            ...
                            <div className="flex flex-col justify-center size-full">
                              <div className="content-stretch flex flex-col gap-[12px] items-start justify-center px-[12px] py-[8px] relative w-full">
                                <div className="content-stretch flex items-center justify-between relative shrink-0 w-[489px]">
                                  ...
                                  <div className="content-stretch flex items-start shrink-0" data-name="Lot Type" />
                                  <div className="bg-white content-stretch flex items-center px-[8px] py-[2px] relative rounded-[128px] shrink-0" data-name="Label">
